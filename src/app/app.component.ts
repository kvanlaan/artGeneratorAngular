...
export class AppComponent {
  ...
  constructor(public utilities: Utilities, public dialog: MatDialog, public location: Location) {
  ...
  renderImage(index?: number) {
    this.generator.renderImage(index)
  }
  ...
  setCustomImages() {
    this.generator.setCustomImages();
  }

  getRandomArt(clear, recurseStep?) {
    this.generator.getRandomArt(clear, recurseStep)
  }
